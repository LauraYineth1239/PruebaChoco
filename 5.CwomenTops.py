...
#SeleccionTops
stps = driver.find_element_by_xpath('//*[@id="subcategories"]/ul/li[1]/div[1]/a')
stps.click()
time.sleep(2)

#VerTop
vtps = driver.find_element_by_xpath('//*[@id="center_column"]/ul/li[1]/div/div[1]/div/a[1]')
vtps.click()
time.sleep(2)

#Filtrarcantidad
cttps = driver.find_element_by_xpath('//*[@id="quantity_wanted_p"]/a[2]')
cttps.click()
time.sleep(2)

#Filtrartalla
tltps = driver.find_element_by_xpath('//*[@id="group_1"]/option[2]')
tltps.click()
time.sleep(2)

#Filtrarcolor
cotps = driver.find_element_by_xpath('//*[@id="color_14"]')
cotps.click()
time.sleep(2)
