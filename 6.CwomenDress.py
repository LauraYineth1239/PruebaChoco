...
#BotonWomen
btwom = driver.find_element_by_xpath('//*[@id="block_top_menu"]/ul/li[1]/a')
btwom.click()
time.sleep(2)

#SeleccionDress
sdre = driver.find_element_by_xpath('//*[@id="subcategories"]/ul/li[2]/div[1]/a')
sdre.click()
time.sleep(2)

#VerDress
vdre = driver.find_element_by_xpath('//*[@id="center_column"]/ul/li[1]/div/div[1]/div/a[1]')
vdre.click()
time.sleep(2)

#Filtrarcantidad
ctdre = driver.find_element_by_xpath('//*[@id="quantity_wanted_p"]/a[2]')
ctdre.click()
time.sleep(2)

#Filtrartalla
tldre = driver.find_element_by_xpath('//*[@id="group_1"]/option[3]')
tldre.click()
time.sleep(2)

#Filtrarcolor
codre = driver.find_element_by_xpath('//*[@id="color_13"]')
codre.click()
time.sleep(2)
