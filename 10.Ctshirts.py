...
#Botonshirt
btsh = driver.find_element_by_xpath('//*[@id="block_top_menu"]/ul/li[3]/a')
btsh.click()
time.sleep(2)


#Vershirt
vshirt = driver.find_element_by_xpath('//*[@id="center_column"]/ul/li/div/div[1]/div/a[1]')
vshirt.click()
time.sleep(2)

#Filtrarcantidad
ctshr = driver.find_element_by_xpath('//*[@id="quantity_wanted_p"]/a[2]')
ctshr.click()
ctshr.click()
time.sleep(2)

#Filtrartalla
tlsh = driver.find_element_by_xpath('//*[@id="group_1"]/option[1]')
tlsh.click()
time.sleep(2)

#Filtrarcolor
cosh = driver.find_element_by_xpath('//*[@id="color_14"]')
cosh.click()
time.sleep(2)
