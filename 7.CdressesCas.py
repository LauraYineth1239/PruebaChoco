...
#SeleccionDressCasual
sdrec = driver.find_element_by_xpath('//*[@id="subcategories"]/ul/li[1]/div[1]/a')
sdrec.click()
time.sleep(2)
...
#Filtrarcantidad
ctdrec = driver.find_element_by_xpath('//*[@id="quantity_wanted_p"]/a[2]')
ctdrec.click()
ctdrec.click()
time.sleep(2)

#Filtrartalla
tldrec = driver.find_element_by_xpath('//*[@id="group_1"]/option[1]')
tldrec.click()
time.sleep(2)

#Filtrarcolor
codrec = driver.find_element_by_xpath('//*[@id="color_13"]')
codrec.click()
time.sleep(2)
